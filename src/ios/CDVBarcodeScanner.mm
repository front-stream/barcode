...
- (UIView*)buildOverlayView {
    ...
    toolbar.barTintColor = [UIColor colorWithRed:255.0f/255.0f green:244.0f/255.0f blue:80.0f/255.0f alpha:1.0f];
    
    UIButton *button = [UIButton buttonWithType:UIButtonTypeCustom];
    button.frame=CGRectMake(0.0, 100.0, 2000.0, 47.0);
    button.backgroundColor = [UIColor colorWithRed:255.0f/255.0f green:244.0f/255.0f blue:80.0f/255.0f alpha:1.0f];
    [button.titleLabel setFont:[UIFont fontWithName:@"cantarell" size:15]];

    [button setTitle:@"Abbrechen" forState:UIControlStateNormal];
    [button setTitleColor:[UIColor colorWithRed:76.0f/255.0f green:0.0f blue:255.0f/255.0f alpha:1.0f] forState:UIControlStateNormal];
    [button addTarget:(id)self action:@selector(cancelButtonPressed:) forControlEvents:UIControlEventTouchUpInside];
    
    id cancelButton = [[UIBarButtonItem alloc] initWithCustomView:button];
...
- (UIImage*)buildReticleImage {
    ...
    if (self.processor.is2D) {
        ...
        CGContextStrokeRect(context,
                            CGRectMake(
                                       RETICLE_SIZE-RETICLE_OFFSET - LINE_LENGTH,
                                       RETICLE_OFFSET,
                                       LINE_LENGTH,
                                       1
                                       )
